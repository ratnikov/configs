...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "1", "2", "3", "4", "5" }, s, awful.layout.suit.tile.left)
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey, }, "F12", function()
      awful.spawn("xscreensaver-command -l")
    ...
    awful.key({ modkey, "Mod1" }, "s", function()
      awful.spawn("/home/ratnikov/ssh-tab", { floating = false })
    end,{description = "chrome ssh", group = "launcher"})
)
...
awful.rules.rules = {
    ...
    -- Make sure Chrome doesn't float. Use xprop | grep WM_CLASS + click on window
    -- to get the class of the rule to adjust.
